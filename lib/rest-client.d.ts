...
import { EnumRestClientMetadata, SymbolBaseUrl, SymbolDefaultHeaders, SymbolHttpClient, SymbolRequestInterceptor, Observable } from './util';
import { IAxiosRequestConfig } from './axios';
interface Parameter {
    key: string;
    parameterIndex: number;
}
declare type UnpackRequestOptions<H extends HttpService> = H extends HttpService<infer U> ? U : IAxiosRequestConfig;
/**
...
export declare function setClassMetadata(metadataKey: string, metadataValue: any, target: object & {
    prototype?: any;
}): void;
 ...
 */
export declare const Path: (key: string) => <RC extends RestClient<HttpService<any>>>(target: RC, propertyKey: string | symbol, parameterIndex: number) => void;
/**
 * Query value of a method's URL, type: string.
 * @param key   query key to bind value.
 */
export declare const Query: (key: string) => <RC extends RestClient<HttpService<any>>>(target: RC, propertyKey: string | symbol, parameterIndex: number) => void;
/**
 * Body of a REST method, type: key-value pair object.
 * Only one body per method!
 */
export declare const Body: <RC extends RestClient<HttpService<any>>>(target: RC, propertyKey: string | symbol, parameterIndex: number) => void;
/**
 * Custom header of a REST method, type: string.
 * @param key   header key to bind value.
 */
export declare const Header: (key: string) => <RC extends RestClient<HttpService<any>>>(target: RC, propertyKey: string | symbol, parameterIndex: number) => void;
 ...
 */
export declare function Headers<SM extends StringMap>(headersDef: SM): <F extends Function>(_target: RestClient<HttpService<any>>, _propertyKey: string, descriptor: IRestClientMethodDescriptor<F, SM>) => IRestClientMethodDescriptor<F, SM>;
export declare function methodBuilder(method: HttpMethod): (url: string) => <RC extends RestClient<HttpService<any>> = RestClient<HttpService<any>>>(target: RC, propertyKey: string | symbol, descriptor: IRestClientMethodDescriptor<Function, StringMap<string>>) => void;
/**
 * GET method.
 * @param url   resource URL of the method
 */
export declare const GET: (url: string) => <RC extends RestClient<HttpService<any>> = RestClient<HttpService<any>>>(target: RC, propertyKey: string | symbol, descriptor: IRestClientMethodDescriptor<Function, StringMap<string>>) => void;
/**
 * POST method.
 * @param url   resource URL of the method
 */
export declare const POST: (url: string) => <RC extends RestClient<HttpService<any>> = RestClient<HttpService<any>>>(target: RC, propertyKey: string | symbol, descriptor: IRestClientMethodDescriptor<Function, StringMap<string>>) => void;
/**
 * PUT method.
 * @param url   resource URL of the method
 */
export declare const PUT: (url: string) => <RC extends RestClient<HttpService<any>> = RestClient<HttpService<any>>>(target: RC, propertyKey: string | symbol, descriptor: IRestClientMethodDescriptor<Function, StringMap<string>>) => void;
/**
 * PATCH method.
 * @param url   resource URL of the method
 */
export declare const PATCH: (url: string) => <RC extends RestClient<HttpService<any>> = RestClient<HttpService<any>>>(target: RC, propertyKey: string | symbol, descriptor: IRestClientMethodDescriptor<Function, StringMap<string>>) => void;
/**
 * DELETE method.
 * @param url   resource URL of the method
 */
export declare const DELETE: (url: string) => <RC extends RestClient<HttpService<any>> = RestClient<HttpService<any>>>(target: RC, propertyKey: string | symbol, descriptor: IRestClientMethodDescriptor<Function, StringMap<string>>) => void;
/**
 * HEAD method.
 * @param url   resource URL of the method
 */
export declare const HEAD: (url: string) => <RC extends RestClient<HttpService<any>> = RestClient<HttpService<any>>>(target: RC, propertyKey: string | symbol, descriptor: IRestClientMethodDescriptor<Function, StringMap<string>>) => void;
export {};
